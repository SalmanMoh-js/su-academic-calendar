...
const MainScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView
      style={tw.style("h-full w-full bg-white")}
      contentContainerStyle={tw.style("flex justify-center ")}
    >
      ...
      >
        <Pressable
          ...
          style={tw.style(
            "flex-col p-3 border border-gray-400 rounded-3xl w-1/3 text-center items-center justify-center"
          )}
        >
          <Icon
            name="calendar"
